...
export const editor = {
    ...
    actions: {
         ...
         * @param data
         */
        addElement({ state, commit, getters }, elData) {
         ...
         * @param data
         */
        elementCommand({ commit, dispatch, state, getters }, command) {
        ...
        copyElement({ state, commit, getters }, elData) {
        ...
        editorUndo({ commit, state, getters }) {
            if (!getters.canUndo) {
                return;
            }
    ...
    mutations: {
        ...
        deleteElement(state, uuid) {
            let activePage = this.getters.activePage
        ...
        resetElementCommonStyle(state, style) {
            let activeElement = this.getters.activeElement
