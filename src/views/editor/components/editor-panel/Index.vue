    ...
    <div class="editor-pane-inner">
      ...
      >
        ...
        >
          <!--页面组件列表展示-->
          <edit-shape
            v-for="(item, index) in activePage.elements"
            :key="'item' + index"
            :uuid="item.uuid"
...
<script>
import { _qk_register_components_object } from "@/views/editor/plugins/index";
import editShape from "@/views/editor/components/components/edit-shape";
