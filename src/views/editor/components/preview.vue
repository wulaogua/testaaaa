...
<script>
	import previewWrapper from '@/views/editor/components/components/preview-wrapper'
	import imageCropper from '@/views/editor/components/components/image-cropper'
