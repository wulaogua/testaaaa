              ...
              <template v-slot:title>
                ...
                <div class="el-animate-title-type-wrapper">
                  <span
                    ...
                    @click.stop="handleShowChooseAnimatePanel(index)"
                    >{{ item.type }}
                ...
                <span
                  ...
                  @click.stop="runAnimate(index)"
                  ><i class="el-icon-caret-right"></i
                ></span>
                <span
                  class="el-animate-title-btn"
                  @click.stop="handleDeleteAnimate"
...
<script>
import animateCssData from "@/views/editor/common/animateCssData.js";
...
export default {
  ...
  methods: {
    ...
    runAnimate(index) {
      ...
      // this.$bus.emit("RUN_ANIMATIONS", this.activeElement.uuid, animationData);
      this.$bus.emit("RUN_ANIMATIONS", {
...
@import "@/views/editor/common/styles/variables.scss";
