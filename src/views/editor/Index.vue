...
import imageLibs from "@/views/editor/components/components/image-libs";
  ...
  methods: {
    ...
    initPageData() {
      ...
      let body = {
        ...
        members: [],
        version: 1,
        _id: "626a5b185f44b153644d59b9",
        pages: [
          {
            uuid: "4b2795f2-362b-4a92-a7f0-71c84ed56b23",
            name: "",
            elements: [
            ],
            commonStyle: {
              backgroundColor: "rgba(201, 40, 40, 1)",
              backgroundImage: "",
              backgroundSize: "cover",
            },
          },
        ],
        author: "626a50f5e2a4cc526c7233da",
        created: "2022-04-28T09:15:04.542Z",
        updated: "2022-04-29T01:10:05.277Z",
        __v: 0,
      };
      //this.loading = true;
      this.$store.dispatch("setPrjectData", {
